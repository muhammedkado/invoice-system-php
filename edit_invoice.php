    	...
    	<form action="" id="invoice-form" method="post" class="invoice-form" role="form" novalidate=""> 
	    	<div class="load-animate animated fadeInUp">
		    	...
		    	<div class="row">
					  ...
					  <label for="lang">Invoice Status:</label>
                    <select   name="status" class="dropdown" id="lang">
					<option value="<?=$invoiceValues['status'];?>"><?=$invoiceValues['status']; ?></option>
						...
						<h3>Email,</h3>
					<div class="form-group">
						<input type="text" value="<?php echo $invoiceValues['email']; ?>" class="form-control" name="email" id="email" placeholder="Email Address" autocomplete="off">
					</div>
						<div class="form-group">
						...
						<h3>Billing Date</h3>
					<div class="form-group">
						<input type="date" class="form-control" name="billing_Date" value="<?php echo $invoiceValues['billing_Date']; ?>"    >
					</div>
					<h3>Due Date</h3>
					<div class="form-group">
						<input type="date" class="form-control" name="due_date" value="<?php echo $invoiceValues['due_date']; ?>"  >
					</div>
		      	...
		      	<div class="row">	
		      		<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
		      			...
		      			<div class="form-group">
							<textarea class="form-control txt" rows="5" name="notes" id="notes" placeholder="Your Notes"><?php echo $invoiceValues['customer_note']; ?></textarea>
						</div>
						<br>
						<div class="form-group">
